...
featured_image: "/images/featured/dnd-personality-convert.png"
...
social_media:
  ...
  og_image: "/images/featured/dnd-personality-convert.png"
  og_type: "website"
  ...
  twitter_image: "/images/featured/dnd-personality-convert.png"
---
...
<div class="form-group">
  ...
  <label for="voiceStyle" class="tooltip">Primary Voice Style *
  ...
  <div class="intensity-slider">
    <label for="primaryIntensity" class="tooltip">Primary Intensity: <span id="primaryIntensityDisplay">7</span>/10
  ...
  <div class="intensity-slider">
    <label for="subIntensity" class="tooltip">Sub Intensity: <span id="subIntensityDisplay">3</span>/10
...
<label for="customVoice">Custom Primary Description *</label>
...
<label for="customSubVoice">Custom Sub Description *</label>
<textarea id="customSubVoice" placeholder="Describe the sub character traits to blend in..." rows="2"></textarea>
</div>

<div class="form-group">
  <label for="preserveOptions" class="tooltip">Preserve Options<span class="tooltiptext">Choose which aspects of the original text to maintain during voice conversion. These options help balance character authenticity with content preservation.</span></label>
  <div class="options-two-column">
  <div class="options-column">
    <label class="checkbox-inline"><input type="checkbox" id="preserveMeaning" checked> Preserve original meaning</label>
    <label class="checkbox-inline"><input type="checkbox" id="preserveLength"> Keep similar length</label>
  </div>
  <div class="options-column" style="border-left: 1px solid #444; padding-left: 15px;">
    <label class="checkbox-inline"><input type="checkbox" id="addMannerisms"> Add character mannerisms</label>
    <label class="checkbox-inline"><input type="checkbox" id="includeDialogueTags"> Include dialogue tags</label>
  </div>
</div>
</div>
</div>
